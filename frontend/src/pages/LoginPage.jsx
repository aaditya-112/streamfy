      ...
      <div className='border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden'>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="form-control w-full">
                      ...
                      <input type="email" className="input input-bordered w-full" placeholder='hello@example.com'
                    ...
                    <div className="form-control w-full">
                      ...
                      <input type="password" className="input input-bordered w-full" placeholder='******' value={loginData.password} onChange={(e)=>setLoginData({...loginData, password:e.target.value})}
                      required />
                    </div>
                  </div>
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">  
            <div className="max-w-md p-8">
              ...
              <div className="text-center soace-y-3 mt-6">
